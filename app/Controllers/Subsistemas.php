...
use App\Models\SubSistemasModel;
...
class Subsistemas extends BaseController
{
    ...
    public function _INCIDENCIAS($value, $row)
    {
        $id_subsistema=$row->id_subsistema;
         $imgsrcbd = base_url() . '/assets/images/incidencias.png';
         
          return
          '
           <a href="' . base_url() . '/incidencias/incidencias_show/' . $id_subsistema . '" style="align-content: center">
           <img src="' . $imgsrcbd . '" height="20px" title="GESTION DE INCIDENCIAS " id="guardar_datos_excel" onclick="" ></img>       
            </a>' ;
    }
