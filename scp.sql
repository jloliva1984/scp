...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2021 at 03:02 AM
...
INSERT INTO `cuentas` (`id_cuenta`, `codigo`, `descripcion`, `valor`, `fecha`) VALUES
(3, '731', 'gastos indirectos', 15000, '2021-02-22');
...
(3, 'IPU-03-701523', 'Almacen de insumos AZUMAT', 500000, '2021-03-15', '2021-03-31', '1'),
(4, NULL, '', 0, NULL, NULL, '1');
...
--
-- Dumping data for table `proyectos_subelemento_gastos`
--

INSERT INTO `proyectos_subelemento_gastos` (`id_proyectos_subelemento_gastos`, `fecha`, `id_proyecto`, `id_subelemento_gasto`, `id_especialista`, `valor`, `estado`) VALUES
(196, '2021-03-08', 1, 1, 1, 100, 0),
(197, '2021-03-16', 1, 2, 2, 250, 0);
...
(1, 'jloliva1984', 'Godblessourfate1.*');
...
--
ALTER TABLE `proyectos_subelemento_gastos`
  MODIFY `id_proyectos_subelemento_gastos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=198;
